...
| `INFLUXDB_USER` | InfluxDB username for authentication. If the host does not require authentication, the value of this variable will be ignored. | `ts` |
| `INFLUXDB_PASS` | InfluxDB password for authentication. If the host does not require authentication, the value of this variable will be ignored. | `123` |
